# Generated by Django 3.0.7 on 2020-06-17 13:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('apiGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='First', to='guoya_api.ApiGroupLevelFirst', verbose_name='所属一级分组')),
            ],
            options={
                'verbose_name': '接口',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='member_project', to='guoya_api.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='dynamic_project', to='guoya_api.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('status', models.BooleanField(default=True, verbose_name='状态')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.Project', verbose_name='项目')),
            ],
            options={
                'verbose_name': 'HOST',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Host', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.GlobalHost', verbose_name='HOST')),
                ('project', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.Project', verbose_name='项目')),
            ],
            options={
                'verbose_name': '用例定时任务',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='test_result', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '手动测试结果',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationGroupLevelFirst', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='automationGroup', to='guoya_api.AutomationGroupLevelFirst', verbose_name='所属用例一级分组')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.Project', verbose_name='所属项目')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='parameterRaw', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '源数据参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='parameterList', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '接口参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interrelate', models.BooleanField(default=False, verbose_name='是否关联')),
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='header', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '请求头',
        ...
        migrations.AddField(
            ...
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.Project', verbose_name='项目'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('automationCaseApi', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='auto_result', to='guoya_api.AutomationCaseApi', verbose_name='接口')),
            ],
            options={
                'verbose_name': '自动测试结果',
        ...
        migrations.AddField(
            ...
            name='automationTestCase',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api', to='guoya_api.AutomationTestCase', verbose_name='用例'),
        ),
        migrations.CreateModel(
            name='ApiResponse',
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response', to='guoya_api.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '返回参数',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='guoya_api.ApiInfo', verbose_name='接口')),
            ],
            options={
                'verbose_name': '接口请求历史',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('api', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameterRaw', to='guoya_api.ApiInfo', verbose_name='所属接口')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, max_length=1024, null=True, verbose_name='描述')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='requestParameter', to='guoya_api.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求参数',
        ...
        migrations.AddField(
            model_name='apiinfo',
            name='project',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='api_project', to='guoya_api.Project', verbose_name='所属项目'),
        ),
        migrations.AddField(
            model_name='apiinfo',
            name='userUpdate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(blank=True, max_length=1024, null=True, verbose_name='内容')),
                ('api', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='headers', to='guoya_api.ApiInfo', verbose_name='所属接口')),
            ],
            options={
                'verbose_name': '请求头',
                'verbose_name_plural': '请求头管理',
